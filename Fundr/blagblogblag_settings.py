...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "middleware"))
print PROJECT_ROOT
#DEBUG = True
...
DATABASES = {
    'default': {
        ...
        'NAME': 'qff_django',                      # Or path to database file if using sqlite3.
        'USER': 'qff_django',                      # Not used with sqlite3.
        'PASSWORD': 's4ntiag0',                  # Not used with sqlite3.
